...
export const GameCard = memo(function GameCard({ game }: GameCardProps) {
  ...
  return (
    <Link to={`/game/${game.id}`} className="group block">
      <div className="relative bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
